    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 px-4">
      <div className="bg-white p-6 rounded shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <input type="text" placeholder="DNI" required className="w-full border p-2 rounded" value={dni} onChange={(e) => setDni(e.target.value)} />
          <button type="submit" className="w-full bg-orange-500 text-white py-2 rounded hover:bg-orange-600">Crear cuenta</button>
        </form>
